...
TAP::TAP ()
{
  ...
  */
  ...
  /*
  ** Create an initial "virtual" good as the root (so the first real good will be
  ** in position 1).
  */
  root = new Good (0, 0);
...
/*
** newGoods: Calculate how many new goods to expect with i parents. This assumes i is
**           (very) small.
**
** Parameters:
**   - pr: The probability alpha_i.
